/* IMPORT */
import { fullArticles } from "./posts.js"
...
export const host = "https://cw0.scrimba.com/"; // replace when relevant host when deploying
const url = ''
...
export const renderAllPosts = function() {
...
export const renderNewestPosts = function() {
...
export const renderPostPreviews = function() {
    for(let i = 0; i < postPreviews.length; i++) {
        postPreviews[i].makePostPreview()
    }
}

export const renderAllPostPreviews = function() {
    for(let i = 0; i < posts.length; i++) {
        posts[i].makePostPreview()
    }
}
